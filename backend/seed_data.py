...
CINEMAS_SEED = [
    {'id': 'c1', 'name': 'PVR: Phoenix Marketcity, Kurla', 'address': 'LBS Marg, Kurla West', 'distance': '4.2 km', 'city': 'Mumbai'},
    {'id': 'c2', 'name': 'INOX: R-City, Ghatkopar', 'address': 'R-City Mall, Ghatkopar West', 'distance': '6.1 km', 'city': 'Mumbai'},
    {'id': 'c3', 'name': 'Cinepolis: Viviana Mall, Thane', 'address': 'Eastern Express Highway', 'distance': '12.5 km', 'city': 'Mumbai'},
    {'id': 'c4', 'name': 'PVR ICON: Infiniti Mall, Andheri', 'address': 'New Link Road, Andheri West', 'distance': '8.3 km', 'city': 'Mumbai'},
    {'id': 'c5', 'name': 'INOX: Atria Mall, Worli', 'address': 'Dr. Annie Besant Road, Worli', 'distance': '10.7 km', 'city': 'Mumbai'}
]
